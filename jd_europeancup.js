...
[task_local]
#欧洲狂欢杯
57 9 * * * https://raw.githubusercontent.com/Wenmoux/scripts/wen/jd/jd_europeancup.js, tag=欧洲狂欢杯, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
*/
const $ = new Env('狂欢欧洲杯');
                ...
                if (err) {
                    ...
                    if (data.data) {
                        if ($.index == 1) {
                            ...
                            console.log(`账号1欧洲杯actid为 ${data.data.activityId}`)
